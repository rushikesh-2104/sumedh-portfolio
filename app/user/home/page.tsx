  ...
  return (
    <div style={{ backgroundImage: "url('/bg3.png')" }} className='h-full w-full'>
      ...
      <div className='pr-2 md:pr-4 lg:pr-8 h-[70vh] md:h-[70vh] lg:h-[87vh] w-auto'>
        <video src="/video1.mp4" autoPlay muted loop playsInline className='h-full w-full object-cover border-r border-t border-b border-slate-300'/>
      </div>
      ...
      <div className="grid lg:grid-cols-4 grid-rows-1 gap-2 bg-white pt-2 md:pt-3 md:px-4 md:mr-4 pb-2 mr-2 px-1  lg:pt-2 lg:pb-2 lg:mr-8 lg:h-[30vh]">
          ...
          <Image src="/mealbox.png" alt='mealbox' width={1500} height={1200} quality={75} className='h-full w-full brightness-50 '/>
          ...
          <div className="relative h-full w-full" >
            <Image src="/menucard.png" alt='mealbox' width={1500} height={1200} quality={75} className='h-full w-full brightness-50 '/>
              <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2">
          ...
          <div className="relative h-full w-full" >
            <Image src="/plating.png" alt='mealbox' width={1500} height={1200} quality={75} className='h-full w-full brightness-50 '/>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2">
          ...
          <div className="relative h-full w-full">
            <Image src="/workshop.png" alt='mealbox' width={1500} height={1200} quality={75} className='h-full w-full brightness-50 '/>
          <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2">
...
<div className="grid lg:grid-cols-2 grid-rows-1 gap-4 bg-white  pb-2 mr-2 px-1  md:pt-3 md:px-4 md:mr-4   lg:pb-2 lg:mr-8 lg:h-[80vh]">
    ...
    <div>
      <Image src="/logo2.png" height={100} width={100} alt='logo' className='object-fill h-full w-full p-8' />
    </div>
