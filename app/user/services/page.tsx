...
const Services = () => {
  return (
    ...
    <div className="grid grid-cols-1 grid-rows-2 gap-2 text-black md:mt-15 mt-5 lg:mt-15 ">
...
<div className="grid lg:grid-cols-2 lg:grid-rows-2 gap-1 pr-2 md:pr-4 lg:pr-8 h-full md:h-full lg:h-full w-auto">
    ...
    <div className='m-2 brightness-60 hover:brightness-100 relative hover:scale-100 scale-97 transition '>
      <Image src="/workshop.png" alt='menucard' height={1200} width={3200} className='h-full w-full rounded-4xl'/>
      <div className="absolute inset-0 flex flex-col items-center justify-center text-center text-white px-2">
